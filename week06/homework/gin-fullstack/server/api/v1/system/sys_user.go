...
func (b *BaseApi) TokenNext(c *gin.Context, user system.SysUser) {
	...
	if err := userService.UpdateLastLoginInfo(user.ID, loginIP, loginTime); err != nil {
		global.GVA_LOG.Error("update last login info failed", zap.Uint("userID", user.ID), zap.Error(err))
	}
