...
![读取config.json文件](./assets/读取configjson文件的优化.png)
...
![读取responseBody](./assets/读取resposeBody.png)
...
![浏览器访问成功的请求体](./assets/浏览器访问成功的请求体.png)
...
![终端运行命令](./assets/终端运行命令.png)

最终成功在 `Raw 文本文件` 这个目标上读取到了“Go”这个字符串，截图如下：

![读取到的Go字符串](./assets/读取到的Go字符串.png)
